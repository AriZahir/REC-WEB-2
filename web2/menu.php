<?php
$path = 'http://' . $_SERVER["HTTP_HOST"] . '/web2';
?>
<nav class="navbar navbar-expand-lg bg-body-tertiary mt-3">
    <div class="container-fluid">
        <img src="<?php echo $path; ?>/arquivos/imagens/ifmscb.png"  width="9%">
        <button class="navbar-toggler" href="" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href=" https://www.ifms.edu.br/">Central</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?php echo $path; ?>/Tab.php" >Horarios dos Campus</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
            ...
            <form class="d-flex" role="search">
                ...
                <a class="btn btn-outline-primary" id="linkLogar" href="https://ead.ifms.edu.br/">Logar</a>
            </form>
        </div>
    </div>
</nav>